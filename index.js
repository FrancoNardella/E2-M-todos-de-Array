...
console.log(`Las siguientes pizzas poseen un Id impar:`);
...
console.log("Si! Las siguientes pizzas tienen valores menores a $600: ");
...
const pizzasNombrePrecio = pizzas.map(
  (pizza) => `${pizza.nombre}: $${pizza.precio}`
);
console.log("Nuestras Pizzas y sus precios: ");

pizzasNombrePrecio.forEach((pizza) => {
  console.log("- " + pizza);
});
...
*/
const pizzasNombreIngredientes = pizzas.map(
  (pizza) => `${pizza.nombre}: ${pizza.ingredientes}.`
);
console.log("Nuestras Pizzas y sus Ingredientes: ");

pizzasNombreIngredientes.forEach((pizza) => {
  console.log("- " + pizza);
});
